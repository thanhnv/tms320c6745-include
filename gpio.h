...
#define GPIO_BANK0_BASE 	(GPIO_0_REGS + 0x010) //GPIO_0_REGS+16
...
#define GPIO_SET_OUT_DATA(port,pin,value)	{\
											*(unsigned int*)(GPIO_0_REGS + 0x010+GPIO_0_BANK_LENGTH*(port/2) + 0x004) &= ~(1<<(pin + 16*(port%2)));\
											*(unsigned int*)(GPIO_0_REGS + 0x010+GPIO_0_BANK_LENGTH*(port/2) + 0x004) |= (value<<(pin+ 16*(port%2)));\
										}

#define GPIO_SET_PIN(port,pin)				*(unsigned int*)(GPIO_0_REGS + 0x010+GPIO_0_BANK_LENGTH*(port/2) + 0x008) |= (1<<(pin+ 16*(port%2)))
#define GPIO_CLR_PIN(port,pin)				*(unsigned int*)(GPIO_0_REGS + 0x010+GPIO_0_BANK_LENGTH*(port/2) + 0x00C) |= (1<<(pin+ 16*(port%2)))
